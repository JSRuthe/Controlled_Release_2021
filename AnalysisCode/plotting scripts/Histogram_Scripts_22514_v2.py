...
fig, axes = plt.subplots(2,6, figsize=(10, 6), facecolor='w', edgecolor='k', gridspec_kw={'width_ratios': [1,4,8,1,4,8], 'height_ratios': [1,1]})
plt.rc('font', **font)
...
#axes[0,0].bar(1, Br_freq.values,color = '#999999',
#            edgecolor='black', linewidth=1.2)
pd.DataFrame(Br_freq).T.plot.bar(stacked = True, ax = axes[0,0], legend = False, color = ['#999999','#59B3A9'], edgecolor='black', linewidth=1.2)
...
axes[0,1].hist(Br_histo_dat, bins = range(0,50+5,5), stacked=True, density = False,
                color=['#8c1515','#D2C295','#175E54', '#279989', '#8F993E'],
                edgecolor='black', linewidth=1.2)
...
(n_Bridger, bins, patches) = axes[0,2].hist(Br_histo_dat, bins = range(50,1550+50,50), stacked=True, density = False, 
    color=['#8c1515','#D2C295','#175E54', '#279989', '#8F993E'], edgecolor='black', linewidth=1.2)
...
#            edgecolor='black', linewidth=1.2)
pd.DataFrame(CM_freq).T.plot.bar(stacked = True, ax = axes[0,3], legend = False, color = ['#999999','#59B3A9'], edgecolor='black', linewidth=1.2)
...
CM_histo_dat = [matchedDF_CarbonMapper.loc[(matchedDF_CarbonMapper['tc_Classification'] == 'TP') &
                ...
                #                           (matchedDF_CarbonMapper['cr_kgh_CH4_mean30'] <= 50),
                #                           'cr_kgh_CH4_mean30']]
axes[0,4].hist(CM_histo_dat, bins = range(0,50+5,5), stacked=True, density = False, color=['#8c1515','#D2C295','#175E54', '#279989', '#8F993E'], edgecolor='black', linewidth=1.2)
...
(n_CM, bins, patches) = axes[0,5].hist(CM_histo_dat, bins = range(50,1550+50,50), stacked=True, density = False, color=['#8c1515','#D2C295','#175E54', '#279989', '#8F993E'], edgecolor='black', linewidth=1.2)
...
plt.show()
plt.savefig('All_histo_23822 _pt1.svg', dpi=300)
...
pd.DataFrame(GHGS_freq).T.plot.bar(stacked = True, ax = axes[1,0], legend = False, color = ['#999999','#59B3A9', '#A6B168'], edgecolor='black', linewidth=1.2)
...
plt.show()
plt.savefig('All_histo_23822_pt2.svg', dpi=300)
