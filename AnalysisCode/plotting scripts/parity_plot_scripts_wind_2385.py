...
def parity_plot(ax, plot_data, Operator, plot_color, force_intercept_origin=1, plot_interval='none',
                plot_lim = [0,10], legend_loc='upper left'):
...
- ax is the plotted parity chart
  ...
  #ax.set_ylabel('Reported release rate [kgh]',fontsize=10)
    ...
    ax.errorbar(x, y, xerr,
            yerr,
            fmt='o', markersize=2, color=plot_color,ecolor="None", elinewidth=1, capsize=0,alpha=0.2);
